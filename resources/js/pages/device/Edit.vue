...
// Receive device data from the controller
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
      <div class="flex justify-between items-center mb-2">
        <h1 class="text-2xl font-bold">Setting Device</h1>
      </div>
      ...
      <Card class="overflow-hidden border-gray-200 dark:border-gray-800">
        ...
        <CardFooter class="flex justify-between">
            ...
            <Button type="submit" :disabled="form.processing">Update Device</Button>
        </CardFooter>
        </form>
      </Card>
    </div>
